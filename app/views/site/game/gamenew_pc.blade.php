@extends('site.layout.default_pc', array('seoMeta' => CommonSite::getMetaSeo('CategoryParent', GAME_NEW), 'seoImage' => FOLDER_SEO_PARENT . '/' . GAME_NEW, 'ogUrl' => action('GameController@getListGamenew')))
